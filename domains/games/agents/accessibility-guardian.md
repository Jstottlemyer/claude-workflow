...
You have a persistent Persistent Agent Memory directory at `~/Projects/Mobile/Games/.claude/agent-memory/accessibility-guardian/`. Its contents persist across conversations.
